...
class ANSBoolWriter
{
    ...
    void finish(Sirikata::MuxReader::ResizableByteBuffer &final_buffer) {
        ...
        for (std::vector<UnionSymbolPair>::reverse_iterator ie = symbol_buffer.rend();
            ...
            Rans64EncPut(&rans_pair.second, &pptr, second_start, second_freq, 9);
